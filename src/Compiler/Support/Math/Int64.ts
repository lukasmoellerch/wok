...
export class Int64 {
  ...
  public static exports = Int64.instance.exports as any;
  public static highLocation: number = Int64.exports.getHighMemoryLocation();
  public static lowLocation: number = Int64.exports.getLowMemoryLocation();
  public static memory = Int64.instance.exports.memory;
  public static dataView = new DataView((Int64.memory as any).buffer);
  public static loadResult(): Int64 {
    const hi = Int64.dataView.getUint32(Int64.highLocation, true);
    const lo = Int64.dataView.getUint32(Int64.lowLocation, true);
  ...
  public add(other: Int64): Int64 {
    Int64.exports.add(this.hi, this.lo, other.hi, other.lo);
    return Int64.loadResult();
  }
  public subtract(other: Int64): Int64 {
    Int64.exports.sub(this.hi, this.lo, other.hi, other.lo);
    return Int64.loadResult();
  }
  public times(other: Int64): Int64 {
    Int64.exports.mul(this.hi, this.lo, other.hi, other.lo);
    return Int64.loadResult();
  }
  public dividedBy(other: Int64): Int64 {
    Int64.exports.divSigned(this.hi, this.lo, other.hi, other.lo);
    return Int64.loadResult();
  }
  public remainder(other: Int64): Int64 {
    Int64.exports.remSigned(this.hi, this.lo, other.hi, other.lo);
    return Int64.loadResult();
  }
  public and(other: Int64): Int64 {
    Int64.exports.and(this.hi, this.lo, other.hi, other.lo);
    return Int64.loadResult();
  }
  public or(other: Int64): Int64 {
    Int64.exports.or(this.hi, this.lo, other.hi, other.lo);
    return Int64.loadResult();
  }
  public xor(other: Int64): Int64 {
    Int64.exports.xor(this.hi, this.lo, other.hi, other.lo);
    return Int64.loadResult();
  }
  public shr(other: Int64): Int64 {
    Int64.exports.shrSigned(this.hi, this.lo, other.hi, other.lo);
    return Int64.loadResult();
  }
}
